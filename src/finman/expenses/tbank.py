...
def parse_operations(text):
    ...
    return df[[
        "id", "Дата и время операции", "Сумма операции в валюте карты", "Валюта карты",
        "Дата списания", "Сумма в валюте операции", "Валюта операции", "Описание операции", "Номер карты"
    ]]
